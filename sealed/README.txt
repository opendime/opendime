...
- copy checksum from "advanced/checksum.txt" and compare to published values on Opendime.com
- visit any of the major block explorers and check balance
- see "index.htm" to for more links


How do I get my funds out?
--------------------------

To be able to move these funds, you must BREAK out the middle part of
the Opendime. Look for the golden lock.
